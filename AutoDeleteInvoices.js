...
// @namespace    http://github.com/xana2333/scut-finance-ui-fix/AutoDeleteInvoices/
// @version      3.3
...
(function () {
    ...
    const defaultConfig = {
        ...
        //BUG反馈（新页面打开URL：https://github.com/xana2333/scut-finance-ui-fix/issues）
    ...
    function toggleFeature(featureKey) {
        tampermonkeyuserConfig[featureKey] = !tampermonkeyuserConfig[featureKey];
        // 保存最新配置
        saveConfig();
        // 输出当前完整配置对象到控制台
